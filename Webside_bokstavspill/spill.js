...
function generateRandomPosition() {
    let length = text_holder.length; //cache the length NB. this length varies per level
...
//assigning the randonposition to every letter
...
startBtn.addEventListener('click', () =>
{
    ...
    lives = 5;
    score = 0;
    scoreEl.innerHTML = score; //updating the html values
    livesText.innerHTML = lives;
    init();
